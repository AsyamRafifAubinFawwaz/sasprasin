        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div class="w-full md:w-1/2 space-y-6">
                ...
                <div class="flex items-center gap-6 pt-4">
                    ...
                    <a href="#cara-kerja" class="flex items-center gap-2 text-[#ff7d26] font-semibold hover:underline smooth-scroll border border-orange-500 px-8 py-4 rounded-2xl">
