                            ...
                            <td class="size-px whitespace-nowrap">
                                <div class="px-6 py-1.5 flex items-center gap-x-2 justify-end">
                                    <a navigate
                                        ...
                                        href="{{ route('student.complaints.detail', $d->id) }}" title="Lihat Detail">
                                        @include('_admin._layout.icons.view_detail')
                                    </a>
                                    @if (
                                        $d->aspiration_status == \App\Constants\ProgressConst::PENDING ||
                                            $d->aspiration_status == \App\Constants\ProgressConst::REJECT)
                                        <a navigate
