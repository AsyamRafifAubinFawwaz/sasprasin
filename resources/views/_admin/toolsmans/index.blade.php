...
@section('content')
            ...
            <form action="{{ route('admin.toolsmans.index') }}" method="GET" navigate-form
                ...
                <div class="relative w-64 max-w-full">
                    <input type="text" name="keywords" id="keywords" value="{{ $keywords ?? '' }}"
                        ...
                        placeholder="Cari Nama Petugas atau No HP">
                </div>
                                ...
                                @forelse($data as $d)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="block text-sm text-gray-800 dark:text-neutral-200">{{ $d->phone ?? '-' }}</span>
                                            </div>
                                        </td>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3 flex items-center gap-2">
                                                @if ($d->active_tasks > 0)
                                                    <span
                                                        class="inline-flex items-center gap-x-1 py-1 px-2.5 rounded-full text-xs font-bold bg-orange-100 text-orange-700 dark:bg-orange-800/30 dark:text-orange-400">
                                                        <span
                                                            class="size-1.5 rounded-full bg-orange-500 animate-pulse"></span>
                                                        {{ $d->active_tasks }} aktif
                                                    </span>
                                                @else
                                                    <span
                                                        class="inline-flex items-center gap-x-1 py-1 px-2.5 rounded-full text-xs font-medium bg-green-50 text-green-600 dark:bg-green-900/20 dark:text-green-400">
                                                        Tersedia
                                                    </span>
                                                @endif
                                                <span
                                                    class="text-xs text-gray-400 dark:text-neutral-500">{{ $d->total_tasks }}
                                                    total</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-1.5 flex items-center gap-x-2 justify-end">
                                                ...
                                                <a navigate
                                                    ...
                                                    href="{{ route('admin.toolsmans.update', $d->id) }}">
    ...
    <x-admin.modal id="delete-modal" title="Hapus Data Petugas">
    ...
    <script>
        ...
        function setResetPasswordData(id, name) {
            ...
            document.getElementById('reset-form').action = '{{ url('admin/toolsmans/reset-password') }}/' + id;
        }
    </script>
@endsection
