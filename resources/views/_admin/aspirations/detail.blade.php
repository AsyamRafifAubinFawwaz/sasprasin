        ...
        <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-900/30 rounded-xl p-6">
            <div class="flex items-center gap-x-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-red-700 dark:text-red-300 mt-1">Pengaduan dengan ID tersebut tidak ditemukan atau
                        telah dihapus.</p>
                </div>
            </div>
        </div>
    @else
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div class="lg:col-span-2 order-2 lg:order-1">
                <div
                    ...
                    <div class="p-6 space-y-6">
                        <div>
                            <label class="block text-sm font-medium mb-2 text-gray-800 dark:text-neutral-200">Nama
                                Siswa</label>
                        ...
                        @if ($data->image)
                            <div>
                                <label
                                    class="block text-sm font-medium mb-2 text-gray-800 dark:text-neutral-200">Gambar</label>
                                <div class="cursor-pointer group" onclick="zoomImage(event)">
                                    <img src="{{ \App\Utils\UrlHelper::getImageUrl($data->image) }}" alt="Gambar pengaduan"
                        ...
                        <div>
                            <label
                                class="block text-sm font-medium mb-2 text-gray-800 dark:text-neutral-200">Kategori</label>
                        ...
                        <div>
                            <label
                                class="block text-sm font-medium mb-2 text-gray-800 dark:text-neutral-200">Deskripsi</label>
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-neutral-400">
                                {{ \Carbon\Carbon::parse($data->created_at)->format('d/m/Y H:i') }} WIB</p>
                        </div>

                        <div>
                            <label
                                class="block text-sm font-medium mb-2 text-gray-800 dark:text-neutral-200">Prioritas</label>
                            <div class="inline-block">
                                ...
                                @elseif($data->priority == 2)
                                    <span
                                        class="inline-flex items-center gap-x-1.5 py-2 px-4 rounded-lg text-sm font-semibold bg-yellow-100 text-yellow-800 dark:bg-yellow-800/30 dark:text-yellow-500 border border-yellow-200 dark:border-yellow-900/30">
                                        <svg class="w-3 h-3 fill-current" viewBox="0 0 6 6">
                                            <circle cx="3" cy="3" r="3" />
                                        </svg>
                                        Prioritas Sedang
                                ...
                                @else
                                    <span
                                        class="inline-flex items-center gap-x-1.5 py-2 px-4 rounded-lg text-sm font-semibold bg-green-100 text-green-800 dark:bg-green-800/30 dark:text-green-500 border border-green-200 dark:border-green-900/30">
                                        <svg class="w-3 h-3 fill-current" viewBox="0 0 6 6">
                                            <circle cx="3" cy="3" r="3" />
                                        </svg>
                                        Prioritas Rendah
                        ...
                        @if ($data->feedback)
                            <div>
                                ...
                                <div
                                    class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-900/30 rounded-lg p-4">
                                    <p class="text-gray-800 dark:text-neutral-200 whitespace-pre-wrap">{{ $data->feedback }}
                                    </p>
                                </div>
                            </div>
                        @endif
            ...
            <div class="lg:col-span-1 order-1 lg:order-2">
                <div
                    class="bg-white overflow-hidden shadow-lg rounded-2xl dark:bg-neutral-800 border-2 border-gray-100 dark:border-neutral-700 sticky top-4">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-neutral-700">
                    ...
                    @if ($student)
                        <div class="p-6">
                            ...
                            <div class="flex flex-col items-center mb-6">
                                <div
                                    class="size-20 flex items-center justify-center rounded-2xl bg-blue-500 text-white text-2xl font-bold shadow-lg mb-3">
                            ...
                            <div class="space-y-4">
                                <div
                                    class="flex items-center justify-between p-3 bg-gray-50 dark:bg-neutral-700/50 rounded-lg">
                                    <div class="flex items-center gap-x-3">
                                        <div
                                            class="size-10 flex items-center justify-center rounded-lg bg-blue-100 dark:bg-blue-900/30">
                                            <svg class="size-5 text-blue-600 dark:text-blue-400" fill="none"
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-x-3">
                                        <div
                                            class="size-10 flex items-center justify-center rounded-lg bg-green-100 dark:bg-green-900/30">
