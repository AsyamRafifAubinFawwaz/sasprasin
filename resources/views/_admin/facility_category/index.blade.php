        ...
        <div>
            <div class="inline-flex gap-x-2">
                <a navigate
                    ...
                    href="{{ route('admin.facility-categories.add') }}">
        ...
        <div class="overflow-x-auto">
            <div class="min-w-full inline-block align-middle">
                <div class="overflow-hidden">
                    ...
                    <div class="px-2 pt-0">
                        <form action="{{ route('admin.facility-categories.index') }}" method="GET" navigate-form
                            ...
                            <div class="sm:w-64">
                                ...
                                <div class="relative">
                                    <input type="text" name="keywords" id="keywords" value="{{ $keywords ?? '' }}"
                                        ...
                                        placeholder="Cari Nama Kategori Fasilitas">
                                </div>
                            </div>
                            <div class="sm:w-48">
                                <select name="priority_level" id="priority_level"
                                    data-hs-select='{"placeholder": "Semua Prioritas", "toggleTag": "<button type=\"button\"></button>",
                                    ...
                                    @foreach ($priority as $priorityValue)
                                        <option value="{{ $priorityValue }}"
                                            {{ ($priority_level ?? request('priority_level')) == $priorityValue ? 'selected' : '' }}>
                                            {{ $priorityValue }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                @if (!empty($keywords) | !empty($priority_level))
                                        ...
                                        <table class="w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                            ...
                                            <div class="px-6 py-3">
                                                @if ($d->priority == \App\Constants\PriorityConst::LOW)
                                                    <span
                                                        class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-white/10 dark:text-white">Low</span>
                                                @elseif($d->priority == \App\Constants\PriorityConst::MEDIUM)
                                                    <span
                                                        class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-800/30 dark:text-blue-500">Medium</span>
                                                @elseif($d->priority == \App\Constants\PriorityConst::HIGH)
                                                    <span
                                                        class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-red-100 text-red-800 dark:bg-red-800/30 dark:text-red-500">High</span>
                                                @endif
                                            </div>
                                        </td>
                                                        <td class="size-px whitespace-nowrap">
                                                        ...
                                                        <td class="size-px whitespace-nowrap">
                                                            <div class="px-6 py-1.5 flex items-center gap-x-2 justify-end">
                                                                ...
                                                                <a navigate
                                                                    ...
                                                                    href="{{ route('admin.facility-categories.update', $d->id) }}">
                    ...
                    <x-admin.modal id="delete-modal" title="Hapus Fasilitas">
                    ...
                    <script>
                        function setDeleteData(id, name) {
                            ...
                            document.getElementById('delete-form').action = '{{ url('admin/facility-categories/delete') }}/' + id;
                        }
                    </script>
                @endsection
