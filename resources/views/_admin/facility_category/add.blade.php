...
@section('content')
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div
            ...
            <form id="add-form" class="p-6" navigate-form action="{{ route('admin.facility-categories.do_create') }}" method="POST">
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="example_items" name="example_items"
                            value="{{ old('example_items') }}"
