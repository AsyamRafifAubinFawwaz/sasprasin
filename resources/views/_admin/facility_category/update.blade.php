    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div
            ...
            <form id="update-form" class="p-6" navigate-form
                action="{{ route('admin.facility-categories.do_update', $id) }}" method="POST">
                @csrf

                <div class="space-y-4">
                    {{-- Name --}}
                    <div>
                        <label for="name" class="block text-sm font-medium mb-2 dark:text-white">Nama <span
                    ...
                    <div>
                        ...
                        <input type="text" id="example_items" name="example_items"
                            value="{{ old('example_items', $data->example_items) }}"
